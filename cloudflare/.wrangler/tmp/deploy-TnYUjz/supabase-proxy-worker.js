...
// supabase-proxy-worker.js
var SUPABASE_URL = "https://avuldnywmiflbmmlgmas.supabase.co";
var ALLOW_HEADERS = "Content-Type, Authorization, apikey, x-upsert, preference, range, accept, cache-control";
var ALLOW_METHODS = "GET, HEAD, POST, PUT, PATCH, DELETE, OPTIONS";
var corsHeaders = {
...
var supabase_proxy_worker_default = {
  async fetch(request) {
    ...
    try {
      const upstream = await fetch(target, {
        ...
        headers,
        body: ["GET", "HEAD", "OPTIONS"].includes(request.method) ? void 0 : await request.arrayBuffer(),
        redirect: "manual"
      });
...
export {
  supabase_proxy_worker_default as default
};
//# sourceMappingURL=supabase-proxy-worker.js.map
